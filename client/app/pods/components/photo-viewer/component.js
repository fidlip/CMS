...
export default Ember.Component.extend({
  ...
  didInsertElement: function () {
    ...
    Ember.$('.photo').imagesLoaded(function () {
      Ember.$('.full-size-photo-viewer').css('opacity', 1);
    });
  ...
  setViewerHeight: function () {
    ...
    Ember.$('.photo').height(height);
    Ember.$('.side-panel').height(height);
  },
